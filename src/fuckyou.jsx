...
export default function Home() {
  return (
    ...
    <div className='page parallax'>
      ...
      <div id='group2' className='parallax__layer parallax__layer--base orange'>
        <div className='text-image parallax__group'>
          <div>
            <h2>Intro</h2>
            <p>
      ...
      <div id='group2' className='parallax__group'>
        <div className='parallax__layer parallax__layer--base'>
          <div className='text-flex'>
            <img src='images/NEW_LOGO-WHITE.png' alt='high-quality render' />
            <div>
